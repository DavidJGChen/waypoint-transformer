...
from decision_transformer.utils_trajectories import (
    edt_evaluate,
...
def save_trajectories(trajectories, filename='model_trajectories.npy'):
...
def test(args):
    ...
    for eval_chk_pt_name in eval_chk_pt_list:
        ...
        try:
            results, indices, frames, episodes = rtn
        except:
            results, indices, episodes = rtn
        
        save_trajectories(episodes)
...
# model save path: dt_runs/edt_hopper-medium-replay-v2_100_model_24-05-19-09-22-26.pt
# log csv save path: dt_runs/edt_hopper-medium-replay-v2_100_log_24-05-19-09-22-26.csv