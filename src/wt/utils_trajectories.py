...
def base_parse():
    ...
    parser.add_argument('--custom_str', type=str, default='4_4_256_60_0.99_100_24-05-31-14-44-36')
...
def edt_evaluate(
    ...
    **kwargs
    ...
    with torch.no_grad():
        ...
        for _ in range(num_eval_ep):
            ...
            for t in range(max_test_ep_len):
                ...
                episode_states.append(running_state)
                ...
                episode_actions.append(act.cpu().numpy())
    ...
    if render:
        return results, indices, frames, episodes

    return results, indices, episodes
